...
import com.kaifa.customview.widget.radar.CustomViewPager;
import com.kaifa.customview.widget.radar.FixedSpeedScroller;
import com.kaifa.customview.widget.radar.Info;
import com.kaifa.customview.widget.radar.RadarViewGroup;
import com.kaifa.customview.transformer.ZoomOutPageTransformer;

import java.lang.reflect.Field;

public class ViewDay09Activity extends BaseActivity implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener {
 ...
 */
    ...
    class ViewpagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            //设置一大堆演示用的数据，麻里麻烦~~
            View view = LayoutInflater.from(ViewDay09Activity.this).inflate(R.layout.viewpager_layout, null);
            ...
            ivPortrait.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(ViewDay09Activity.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
                }
            });
