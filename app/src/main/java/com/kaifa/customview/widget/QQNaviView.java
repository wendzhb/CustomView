...
public class QQNaviView extends LinearLayout {
    ...
    public QQNaviView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mBigIconSrc = ta.getResourceId(R.styleable.QQNaviView_bigIconSrc, R.mipmap.ic_launcher);
        mSmallIconSrc = ta.getResourceId(R.styleable.QQNaviView_smallIconSrc, R.mipmap.ic_launcher_round);
